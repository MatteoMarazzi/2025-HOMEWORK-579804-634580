...
public class CaricatoreLabirinto {
	...
	private void leggiECreaStanzeBloccate() throws FormatoFileNonValidoException {
		...
		for (String specificaStanzaBloccata : separaStringheAlleVirgole(specificheStanzeBloccate)) {
			...
			this.builder.addStanzaBloccata(nomeStanzaBloccata, nomeAttrezzoSblocco, dir);
		}
	}
	...
	private void posaAttrezzo(String nomeAttrezzo, String pesoAttrezzo, String nomeStanza)
	    ...
	    try {
	        ...
	        // prima imposta la stanza corrente sul builder
	        builder.addStanza(nomeStanza);
	        // poi aggiunge l’attrezzo a quella stanza
